...
const AddUser = () => {
  ...
  const [role_id, setRoleId] = useState(""); // Default "User" role ID
  ...
  async function onSubmit(e) {
    ...
    try {
      ...
      if (result.success) {
        setSuccessMessage(result.message || "Add user successful!");
        ...
        setErrorMessage(result.message || "Add user failed");
      ...
      <form onSubmit={onSubmit} className="inputs">
        <div className="input">
          <select
            ...
            value={role_id}
            onChange={handleRoleChange} // Proper event handling
            required
          >
            <option value="66b07827989986d3cc8f438d">User</option>
            <option value="66b077fe989986d3cc8f438c">Admin</option>
          </select>
        </div>
